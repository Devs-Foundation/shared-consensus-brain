...
Ein Panel mit Statistiken über die **Maschine, die das Brain hostet**: CPU-Modell und Kerne, CPU-Auslastung, RAM, belegter/freier Speicherplatz und eine **Brain-Wachstums**-Schätzung basierend auf der durchschnittlichen Notizgröße. Diese Werte sind **lokal und informativ** — die Wachstumszahl ist eine grobe Schätzung, **kein** Versprechen unendlichen Speichers. Dauerhafter, erweiterbarer Speicher kommt von der Festplatte und von Git, nicht von Magie.
