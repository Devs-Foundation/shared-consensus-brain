...
Um painel com estatísticas sobre a **máquina que aloja o cérebro**: modelo e núcleos do CPU, carga do CPU, RAM, disco usado/livre, e uma estimativa de **crescimento do cérebro** baseada no tamanho médio das notas. Estas leituras são **locais e informativas** — o valor de crescimento é uma estimativa aproximada, **não** uma promessa de armazenamento infinito. Memória persistente e expansível vem do disco e do git, não de magia.
