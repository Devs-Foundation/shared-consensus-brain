...
Un panel con estadísticas sobre la **máquina que aloja el cerebro**: modelo y núcleos de la CPU, carga de la CPU, RAM, disco usado/libre, y una estimación de **crecimiento del cerebro** basada en el tamaño medio de las notas. Estas lecturas son **locales e informativas** — la cifra de crecimiento es una estimación aproximada, **no** una promesa de almacenamiento infinito. La memoria persistente y expandible viene del disco y de git, no de la magia.
